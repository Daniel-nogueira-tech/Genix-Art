...
const Navbar = () => {
    ...
    return (
        <div className="flex items-center justify-between py-4 gap-5">
            <Link to="/">
                <img src={assets.logo} alt="Logo" className="w-28 sm:w-20 lg:w-20 rounded-xl" />
            </Link>
                ...
                {user ? (
                    <div className="relative flex items-center gap-2 sm:gap-3 ">
                        ...
                        <div className="relative group">
                            <img src={assets.user} alt="User" className="w-10 drop-shadow cursor-pointer" />
                            <div className="absolute hidden group-hover:block right-0 bg-white shadow-md text-black rounded pt-2 mt-0.01 w-32">
